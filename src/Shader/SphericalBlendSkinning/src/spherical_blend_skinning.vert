...
// >>>>>>>> CHANGED!
#include <spherical_blend_pars_vertex>
...
void main() {
  ...
  // >>>>>>>> are replaced by custom spherical_blend_* ones.
  #include <spherical_blend_skinbase_vertex>
  #include <spherical_blend_skinnormal_vertex>
  ...
  // >>>>>>>> spherical_blend_skinning_vertex shader chunk.
  #include <spherical_blend_skinning_vertex>
