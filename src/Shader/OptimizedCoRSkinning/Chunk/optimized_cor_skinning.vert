...
// >>>>>>>> CHANGED!
#include <optimized_cor_pars_vertex>
...
void main() {
  ...
  // >>>>>>>> are replaced by custom optimized_cor_* ones.
  #include <optimized_cor_skinbase_vertex>
  #include <optimized_cor_skinnormal_vertex>
  ...
  // >>>>>>>> optimized_cor_skinning_vertex shader chunk.
  #include <optimized_cor_skinning_vertex>
